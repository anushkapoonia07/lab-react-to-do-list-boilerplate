...
function App() {
  ...
  return (
    <div className='CONTAINER'>
      <div>
        <input className='Text' type='text' placeholder='Type here' value={item} onChange={(e) => changeItem(e)}/>
        <button type='submit' onClick={addItemToList}>Add Item</button>
      </div>
      <div>
        {todos.map((todo, index) => (
          <div key={index}>
            <input type='text' className='Texts' value={todo} onChange={(e) => editItem(index, e)}/>
